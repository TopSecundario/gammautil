...
public class TestRoundLabel {

    @Test
    public void test_RoundLabel() {
        ...
        TestDialog testDialog = TestDialog.display("Test: RoundLabel", this::createTestArea, checkList, dbv);
    ...
    private JPanel createTestArea() {
        ...
        panel.add(rlExample, "span, center");
